...
650 N Ross            & \textit{Voice:} (256) 345-9938 \\
Apartment G8           & \textit{E-mail:}
\href{mailto:wjwwood@gmail.com}{wjwwood@gmail.com}\\
Auburn, AL 36830    & \textit{WWW:}
\href{http://www.williamjwoodall.com/}{williamjwoodall.com}\\
\end{tabular}

\section{Research Interests}
%
Robotics, Unix Operating Systems, Computer Vision, Information Technology
...
%
\href{http://proteus.ausparc.com}{\textbf{Proteus Project, Auburn University}}, 
Auburn, AL
\begin{outerlist}

\item[] \textit{Undergraduate Research Assistant}%
        \hfill \textbf{Spring 2010 - Present}
\begin{innerlist}
\item Develop Hardware Interfaces and Design Simulations for mobile robots and UAV's
\end{innerlist}
...
%        \hfill \textbf{Summer 2009 - Present}
%\begin{innerlist}
...
Lunar Excavator Team, Auburn University \hfill \textbf{Fall 2009 - Present}

\blankline

\href{http://ausparc.com/projects/show/automow-2010}{Autonomous Lawnmower Team}, Auburn University \hfill \textbf{Summer 2009 to present}
\begin{innerlist}
...
\href{http://sparc.eng.auburn.edu/}{Student Projects and Research Committee} (SPaRC) \hfill \textbf{Fall 2007 to present}
\begin{innerlist}
\item Project leader for 2009 hardware team; First Place at the IEEE SouthEastCON '09
\end{innerlist}
...
\textit{Programming}: Python, C/C++, Java, PHP, ActionScript, Ruby, Perl, javascript, SQL \\
\null \hfill \textit{note: Languages listed in order of proficiency}

\textit{Frameworks/Libraries}: OpenCV, iPhone SDK, wxWidgets, Player/Stage, ROS, Ogre3D

\blankline

\textit{Applications}: \LaTeX{}, iWork, Microsoft Office, Solid Edge, 3DS Max, Trac, Redmine, Basecamp, Eclipse, Netbeans, XCode, Visual Studio, GIT, SVN, PhotoShop
